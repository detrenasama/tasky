...
Использование:
  ...
  tasky web           запустить сервер и открыть веб-интерфейс в браузере
  ...
  tasky upgrade [-y]  обновить до последней версии (без -y запрашивает подтверждение; по умолчанию — да)
